...
const Footer: React.FC = () => {
  return (
    <div className="w-full bg-[#efefef] h-[300px] sticky bottom-0">
      {/* Footer Section */}
      <div className="w-full bg-[#f2f4e1] flex justify-between items-center py-12 px-6">
        {/* Left Section: Links */}
      ...
      <div className="w-full bg-[#efefef] flex justify-center items-center py-4">
